...
import { addMapElementsControllers, createAvatar, createMapController, updateElement } from '../controllers/admin.controller';
...
adminRouter.use((req:Request,res:Response,next:NextFunction)=>{
    if(req.userRole!=role.Admin)
        throw new AppError(HttpStatusCode.Unauthorized,"You are not authorized to access this route");
})
