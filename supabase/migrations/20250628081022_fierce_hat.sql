...
INSERT INTO "Avatar" (id, name, imageUrl) VALUES 
...
INSERT INTO "Element" (id, name, width, height, imageUrl, static) VALUES 
('element-1', 'Tree', 64, 96, '1732114668032-281862181.png', true),
('element-2', 'Rock', 48, 48, '1732114932154-110281092.png', true),
('element-3', 'Flower', 32, 32, '1732115045621-312396897.png', false),
('element-4', 'Bush', 56, 56, '1732115073894-821103395.png', true),
('element-5', 'Bench', 80, 40, '1732115110823-645079520.png', false),
('element-6', 'Lamp Post', 32, 128, '1732115163690-899076529.png', true),
('element-7', 'Fountain', 96, 96, '1732115204968-951667987.png', true),
('element-8', 'Statue', 64, 128, '1732115266239-182801870.png', true),
('element-9', 'Table', 64, 64, '1732115323957-297588416.png', false),
('element-10', 'Chair', 32, 32, '1732708288869-112048154.png', false),
('element-11', 'Bookshelf', 64, 96, '1732708349370-546371723.png', true),
('element-12', 'Computer', 48, 48, '1732708397399-467840180.png', false),
('element-13', 'Plant Pot', 32, 48, '1732708463260-848389643.png', false),
('element-14', 'Sofa', 96, 48, '1732708816536-800453113.png', false),
('element-15', 'Coffee Table', 80, 48, '1732709177294-148279928.png', false)
ON CONFLICT (id) DO NOTHING;

-- Insert maps with different themes
INSERT INTO "Map" (id, name, width, height, dropX, dropY, thumbnail) VALUES 
...
INSERT INTO "MapElement" (id, mapId, elementId, x, y) VALUES 
...
INSERT INTO "Space" (id, name, mapId, capacity, public, creatorId) VALUES 
('space-1', 'Community Park', 'map-1', 50, true, 'admin-user-id'),
('space-2', 'Co-working Office', 'map-2', 25, true, 'admin-user-id'),
('space-3', 'Virtual Cafe', 'map-3', 30, true, 'admin-user-id'),
('space-4', 'Study Together', 'map-4', 40, true, 'admin-user-id')
ON CONFLICT (id) DO NOTHING;